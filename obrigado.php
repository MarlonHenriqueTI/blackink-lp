...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50" style="background:#2f2f2f!important;">
        <form action="cadastrar-orcamento.php" method="POST" id="formulario-reg-log" enctype="multipart/form-data">
				<form class="login100-form validate-form" method="POST" action="http://dropink.art.br/cadastrar-orcamento-lp.php" >
					<img src="images/logo-blackink-clara.png" alt="logo" class="logo-meio">
					<span class="login100-form-title p-b-59" style="color: #FFF;">
						Seu orçamento foi enviado e em breve nós estaremos te respondendo... Obrigado!
					</span>
				</form>
			</div>
		</div>
