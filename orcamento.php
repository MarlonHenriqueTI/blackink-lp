...
<body style="background-color: #999999;">
	...
	<div class="limiter">
        ...
        <form action="http://dropink.art.br/admin/cadastrar-orcamento-lp.php" method="POST" id="formulario-reg-log" enctype="multipart/form-data">
					...
					<div class="wrap-input100 validate-input" data-validate="Digite o nome">
						...
						<input class="input100" type="text" name="nome" placeholder="Seu nome" required>
						<span class="focus-input100"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Digite o seu telefone">
						<span class="label-input100">Telefone</span>
						<input class="input100" type="text" name="telefone" placeholder="(xx)xxxxx-xxxx" required>
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" data-validate="Digite sua data de nascimento">
						...
						<input class="input100" type="date" name="nascimento" placeholder="Quando você nasceu?" required>
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100 validate-input">
						...
						<input class="input100" type="file" name="foto_local" placeholder="foto do local" accept="image/*">
						<span class="focus-input100"></span>
						<small>Nos envie uma foto do local que você deseja fazer a tattoo</small>
					</div>
